import heroImg from '../assets/section_hero.png';
import React, { useState, useEffect, useRef } from 'react';

// Composants d'icônes SVG (pour éviter les dépendances externes)
        const IconCheck = () => (
        ...
        const IconBox = () => (
            <svg className="w-8 h-8 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
        );
        const IconLayers = () => (
            <svg className="w-8 h-8 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
        );
        const IconSmile = () => (
            <svg className="w-8 h-8 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
        );
        const IconMenu = () => (
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="flex flex-col items-center justify-center pt-4 pb-12">
                            ...
                            <div className="relative mx-auto w-full max-w-6xl fade-in-up delay-200 group px-2 sm:px-0">
                                <img src={heroImg} alt="Aperçu de l'application GestionPro" className="w-full h-auto object-contain drop-shadow-2xl rounded-2xl transition-transform duration-500 group-hover:scale-[1.01]" />
                            </div>
                        </div>
                    </div>
